    ...
    <div className="accueil-container2">
      ...
      <div className="actualite-container">
        ...
        <div className="actualite-box">
          <Actualite
            image={divinaCommedia} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={zerocalcare} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={greenPea} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={sergio} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={dal} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={raffaelloSuperstar} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={lupi} alt="Description de l'image"
        ...
        <div className="actualite-box">
          <Actualite
            image={portata} alt="Description de l'image"
